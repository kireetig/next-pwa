...
workbox.routing.registerRoute(/^https:\/\/api.themoviedb.org\/3\/movie/, workbox.strategies.staleWhileRevalidate({ "cacheName":"api-cache", plugins: [new workbox.cacheableResponse.Plugin({"statuses":[200]})] }), 'GET');
